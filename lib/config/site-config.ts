...
export const siteConfig: SiteConfig = {
  title: process.env.NEXT_PUBLIC_SITE_TITLE || "WuVideo",
  description: process.env.NEXT_PUBLIC_SITE_DESCRIPTION || "WuVideo",
  name: process.env.NEXT_PUBLIC_SITE_NAME || "WuVideo",
};
